        ...
        <form method="POST" action="{{ route('asesor.update', [$asesor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <!-- <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('disponibilidad') ? 'is-invalid' : '' }}" type="text" name="disponibilidad" id="disponibilidad" value="{{ old('disponibilidad', $asesor->disponibilidad) }}">
