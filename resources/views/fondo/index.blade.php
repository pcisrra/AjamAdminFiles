    ...
    <div class="row" style="margin-bottom: 10px;">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="col-lg-12" align="right">
                <a class="btn btn-success" href="{{ route('fondo.create') }}"> Agregar Nuevo</a>
            </div>
            @endcan
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr data-entry-id="{{ $datos->id }}">
                    ...
                    <td>
                        ...
                        <form action="{{ route('fondo.destroy', str_replace('/','',$datos->contenedor)) }}" method="POST">
                            @csrf                            
                            @method('DELETE')
