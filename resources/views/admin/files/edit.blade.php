    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.files.update", [$file->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ext_dates') ? 'is-invalid' : '' }}" type="number" name="ext_dates" id="ext_dates" value="{{ old('ext_dates', $file->ext_dates) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $file->description) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('background') ? 'is-invalid' : '' }}" type="text" name="background" id="background" value="{{ old('background', $file->background) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="text" name="quantity" id="quantity" value="{{ old('quantity', $file->quantity) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_folios') ? 'is-invalid' : '' }}" type="text" name="num_folios" id="num_folios" value="{{ old('num_folios', $file->num_folios) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('observations') ? 'is-invalid' : '' }}" type="text" name="observations" id="observations" value="{{ old('observations', $file->observations) }}">
